...
Then replace `<source_token>` and `<ingesting_host>` in `config.ru` with your actual source token which you can find by going to [Better Stack Telemetry](https://teleemetry.betterstack.com/dashboard) -> Source -> Configure.
